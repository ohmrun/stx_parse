...
class ParserLift{
  ...
  static public inline function and<I,T,U>(pI:Parser<I,T>,p2 : Parser<I,U>):Parser<I,Couple<T,U>>{
    return new stx.parse.pack.parser.term.CoupleWith(pI,p2).asParser();
  }
  static public inline function and_seq<I,T>(pI:Parser<I,T>,p2 : Parser<I,T>):Parser<I,Array<T>>{
    return new stx.parse.pack.parser.term.AnonWith(pI,p2,(l:T,r:T) -> [l,r]).asParser();
  }
  ...
  static public inline function regexParser(str : String):Parser<String,String>{
    return new Parser(new stx.parse.pack.parser.term.Regex(str));
  }
  ...
  static public inline function option<I,T>(p:Parser<I,T>):Parser<I,StdOption<T>>{
    return new Parser(new stx.parse.pack.parser.term.Option(p));
  }
